// Model é uma classe base que o Sequelize fornece para criar modelos que represntam tabelas no banco de dados. DataTypes é um objeto que contém os tipos dedados que você pode usar para definir os campos/colunas da sua tabela, como "STRING", "INTEGER", "DATE", etc.
...
class User extends Model {
  ...
  static init(sequelize) {
    super.init(
      /* // super refere-se à classe pai (Model). Ao usar super.init chamamos o método .init do Model, que já sabe lidar com a configuração do Modelo. Se usássemos apenas init, esse seria um método específico da subclasse, e não aquele herdado da classe pai.
      Note o método: init(<parameter>)... sequelize é um parâmetro, que é passado no index.js. observe lá para entender melhor... */
      {
